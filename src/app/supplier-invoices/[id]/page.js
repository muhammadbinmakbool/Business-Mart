  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Column 1: Invoiced Items details */}
        <div className="rounded-xl border bg-card shadow-sm overflow-hidden flex flex-col justify-between h-full min-h-[320px]">
          <div>
        ...
        {/* Column 2: Amount Calculation & Supplier Card */}
        <div className="rounded-xl border bg-card shadow-sm overflow-hidden flex flex-col justify-between h-full min-h-[320px]">
