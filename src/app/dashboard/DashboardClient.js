  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-900 pb-5">
        <div>
          <h1 className="text-3xl font-extrabold tracking-tight">Control Room</h1>
          <p className="text-sm text-slate-400">Real-time operational overview. Read-only observer layer.</p>
        </div>
        
        {/* Connection status indicator */}
        <div className="flex items-center gap-2 bg-slate-950 px-3 py-1.5 rounded-lg border border-slate-800 self-start text-[11px] font-semibold text-emerald-400">
