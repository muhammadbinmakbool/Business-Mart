  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 pb-16">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground">Manage system configuration, organization profile, and developer tools.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {/* Left Navigation Tabs */}
        <div className="md:col-span-1 space-y-1">
          <button className="w-full text-left px-3 py-2 text-sm font-semibold rounded-lg bg-primary text-primary-foreground flex items-center gap-2">
            <Sliders className="h-4 w-4" />
            General Setup
          </button>
          <button className="w-full text-left px-3 py-2 text-sm font-medium rounded-lg text-muted-foreground hover:bg-accent hover:text-accent-foreground flex items-center gap-2 opacity-50 cursor-not-allowed">
