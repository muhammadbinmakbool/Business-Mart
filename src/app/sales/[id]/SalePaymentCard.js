    ...
    <div className="rounded-2xl border bg-card p-6 shadow-sm space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 pt-2 text-sm">
        <div className="bg-muted/10 p-3 rounded-xl border border-muted/20">
          <div className="text-[10px] uppercase font-bold text-muted-foreground tracking-wider">Total Received</div>
          <div className="text-base font-black text-foreground mt-1">
            Rs. {paid.toLocaleString()}
          </div>
        </div>
        <div className="bg-primary/5 p-3 rounded-xl border border-primary/10">
          <div className="text-[10px] uppercase font-bold text-primary tracking-wider">Remaining Balance</div>
          <div className={cn(
