...
export const DOC_DICTIONARY = {
  en: {
    ...
    systemTime: "Status Update Timestamp",
    productName: "Product Name",
    grossWeight: "Gross Quantity",
    bags: "Bags",
    ...
    grossValue: "Base Amount",
    intakeDeductions: "Intake Adjustments",
    netIntake: "Net Amount",
    ...
    totalGrossValue: "Base Amount",
    totalDeductions: "Total Adjustments",
    advancesDeducted: "Advances Deducted",
    netPayableAmount: "Final Total",
  ...
  ur: {
    ...
    systemTime: "اسٹیٹس اپ ڈیٹ ٹائم اسٹیمپ",
    productName: "جنس کا نام",
    grossWeight: "کل مقدار",
    bags: "بوریاں",
    ...
    grossValue: "بنیادی رقم (Base Amount)",
    intakeDeductions: "کل ایڈجسٹمنٹ (Total Adjustments)",
    netIntake: "خالص رقم (Net Amount)",
    ...
    totalGrossValue: "بنیادی رقم (Base Amount)",
    totalDeductions: "کل ایڈجسٹمنٹ (Total Adjustments)",
    advancesDeducted: "منہا شدہ پیشگی رقوم",
    netPayableAmount: "حتمی ٹوٹل (Final Total)",
