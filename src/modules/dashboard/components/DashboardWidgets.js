...
export function QuickActionsWidget() {
  const actions = [
    { title: "New Intake", desc: "Record supplier goods intake", href: "/intake/create?backUrl=/dashboard", icon: Plus, color: "text-sky-600 dark:text-sky-400 bg-sky-50 dark:bg-sky-950/40 border-sky-100 dark:border-sky-900" },
    { title: "New Sale", desc: "Create a customer invoice", href: "/sales/create?backUrl=/dashboard", icon: FileText, color: "text-violet-600 dark:text-violet-400 bg-violet-50 dark:bg-violet-950/40 border-violet-100 dark:border-violet-900" },
    { title: "New Settlement", desc: "Settle supplier balances", href: "/supplier-invoices/create?backUrl=/dashboard", icon: DollarSign, color: "text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-950/40 border-amber-100 dark:border-amber-900" },
    { title: "New Product", desc: "Register an inventory item", href: "/products/create?backUrl=/dashboard", icon: Package, color: "text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/40 border-emerald-100 dark:border-emerald-900" },
    ...
    { title: "New Advance", desc: "Issue supplier cash advance", href: "/advances/create?backUrl=/dashboard", icon: Banknote, color: "text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-950/40 border-rose-100 dark:border-rose-900" },
  ];
