-- AlterTable
ALTER TABLE "Party" ADD COLUMN "source" TEXT;
...
CREATE TABLE "new_SalesTrack" (
    ...
    "type" TEXT NOT NULL DEFAULT 'INTAKE_SALE',
...
INSERT INTO "new_SalesTrack" ("baseAmount", "businessId", "buyerPartyId", "buyingRate", "createdAt", "deleteReason", "deletedAt", "deletedBy", "id", "initialStockId", "intakeTransactionId", "isBilled", "isDeleted", "isSettled", "netWeight", "notes", "productId", "quantity", "rateUnit", "saleItemId", "saleTransactionId", "sellingRate", "supplierPartyId", "updatedAt", "userId") SELECT "baseAmount", "businessId", "buyerPartyId", "buyingRate", "createdAt", "deleteReason", "deletedAt", "deletedBy", "id", "initialStockId", "intakeTransactionId", "isBilled", "isDeleted", "isSettled", "netWeight", "notes", "productId", "quantity", "rateUnit", "saleItemId", "saleTransactionId", "sellingRate", "supplierPartyId", "updatedAt", "userId" FROM "SalesTrack";
